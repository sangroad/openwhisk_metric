...
parser.add_argument('--mon-interval', dest='mon_interval', type=int, required=True)
...
metric_file = open(f'./data/only_metric_{args.users}_{args.runtime}_{args.mon_interval}ms.csv')
result_file = open(f'./data/data_{args.users}_{args.runtime}_{args.mon_interval}ms.csv', 'w')
